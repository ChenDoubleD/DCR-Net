...
from models.data.utils import IMG_FORMATS
from models.utils import LOGGER, TORCH_VERSION
from models.utils.checks import check_requirements
from models.utils.torch_utils import TORCH_2_4, select_device
...
class VisualAISearch:
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        if not self.data_dir.exists():
            from models.utils import ASSETS_URL
