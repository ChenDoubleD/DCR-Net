...
from models.utils.export import (
    keras2pb,
    onnx2engine,
    onnx2saved_model,
    pb2tfjs,
...
from models.utils.nms import TorchNMS
from models.utils.ops import Profile
from models.utils.patches import arange_patch
...
class Exporter:
    ...
    Examples:
        ...
        >>> from models.engine.exporter import Exporter
        >>> exporter = Exporter()
    ...
    def __call__(self, model=None) -> str:
        ...
        if imx:
            from models.utils.export.imx import FXModel

            model = FXModel(model, self.imgsz)
        if tflite or edgetpu:
            from models.utils.export.tensorflow import tf_wrapper
