...
from models.nn.tasks import guess_model_task, load_checkpoint, yaml_model_load
...
class Model(torch.nn.Module):
    ...
    def __init__(
        ...
        if self.is_hub_model(model):
            from models.hub import HUBTrainingSession
    ...
    def is_hub_model(model: str) -> bool:
        ...
        Examples:
            ...
            False
        """
        from models.hub import HUB_WEB_ROOT
