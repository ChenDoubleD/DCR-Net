...
from models.data import YOLOConcatDataset, build_dataloader, build_yolo_dataset
from models.data.augment import LoadVisualPrompt
...
from models.nn.modules.head import YOLOEDetect
from models.nn.tasks import YOLOEModel
from models.utils import LOGGER, TQDM
    ...
    def __call__(
        ...
        if trainer is not None:
            ...
            if isinstance(model, (str, Path)):
                from models.nn.tasks import load_checkpoint
